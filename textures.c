...
void	draw_game(t_data *data, int x)
{
	...
	data->texture.pos = (data->texture.draw_start - WIN_HEIGHT
			/ 2 + data->rays->line_height / 2) * data->texture.step;
...
{
	load_texture_to_buffer(data, NORTH, "textures/wallNorth.xpm");
	load_texture_to_buffer(data, SOUTH, "textures/wallSouth.xpm");
	load_texture_to_buffer(data, EAST, "textures/wallEast.xpm");
	load_texture_to_buffer(data, WEST, "textures/wallWest.xpm");
}
